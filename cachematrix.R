...
## Write a short comment describing this function
#this function calculates the inverse of a square matrix if stored in the structure of the makeChacheMatrix
#it returns null and prints a message otherwise
